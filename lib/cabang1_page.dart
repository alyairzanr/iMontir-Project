...
import 'riwayat_cabang1_page.dart';
import 'pompa_air1_page.dart';

class Cabang1Page extends StatelessWidget {
  Cabang1Page({Key? key}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => RiwayatKetinggianAir1Page()), 
                        );
                      },
                      child: Text(
                        'Selengkapnya',
